...
export default function ServicesGrid() {
  const services = [
    {
      icon: <Landmark className="w-5 h-5 sm:w-6 sm:h-6 text-[#EA580C]" />,
    ...
    {
      icon: <HandCoins className="w-5 h-5 sm:w-6 sm:h-6 text-[#EA580C]" />,
    ...
    {
      icon: <FileSignature className="w-5 h-5 sm:w-6 sm:h-6 text-[#EA580C]" />,
      title: "Operating Agreement",
      description: "Get an operating agreement to define your LLC's internal structure and each member's roles.",
    },
    {
      icon: <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[#EA580C]" />,
    ...
    {
      icon: <FileEdit className="w-5 h-5 sm:w-6 sm:h-6 text-[#EA580C]" />,
    ...
    {
      icon: <FileX className="w-5 h-5 sm:w-6 sm:h-6 text-[#EA580C]" />,
      title: "Dissolution",
      description:
